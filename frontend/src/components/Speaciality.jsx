...
const Speaciality = () => {
    return (
        <div className='flex flex-col items-center gap-4 py-16 text-gray-800 ' id='speciality'>
            ...
            <p className='sm:w-1/3 text-center gap-4 pt-5 w-full overflow-scroll'>Simply browse through our extensive list of trusted doctors, schedule your appoinetment hasle-free.
            </p>
